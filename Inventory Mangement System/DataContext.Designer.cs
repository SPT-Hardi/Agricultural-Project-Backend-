...
// Code is generated on: 15-02-2022 12:24:21
//
...
namespace ProductInventoryContext
{
    ...
    public partial class ProductInventoryDataContext : Devart.Data.Linq.DataContext
    {
        ...
        base(@"Data Source=DESKTOP-ED3OOSD;Initial Catalog=""Product Inventory"";Integrated Security=False;Persist Security Info=True;User ID=SuperAdmin;Password=SuperAdmin", mappingSource)
        {
            OnCreated();
        }
