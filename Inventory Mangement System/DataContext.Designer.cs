...
// Code is generated on: 4/16/2022 11:19:36 AM
//
...
namespace ProductInventoryContext
{
    ...
    public partial class ProductInventoryDataContext : Devart.Data.Linq.DataContext
    {
        ...
        base(@"Data Source=20.204.136.73;Initial Catalog=ProductInventory;Integrated Security=False;Persist Security Info=True;User ID=piDB;Password=PI@2022@@#", mappingSource)
        {
            OnCreated();
        }
...
namespace ProductInventoryContext
{
    ...
    /// </summary>
    [Table(Name = @"dbo.UserRefreshTokens")]
