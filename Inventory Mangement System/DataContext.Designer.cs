...
// Code is generated on: 07-02-2022 15:51:10
//
...
namespace ProductInventoryContext
{
    ...
    public partial class Issue : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Remark", DbType = "VARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class LoginDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<PurchaseDetail> _PurchaseDetails_LoginID;

        private EntitySet<PurchaseDetail> _PurchaseDetails_LoginID1;
        ...
        public LoginDetail()
        {
            ...
            this._Products = new EntitySet<Product>(new Action<Product>(this.attach_Products), new Action<Product>(this.detach_Products));
            this._PurchaseDetails_LoginID = new EntitySet<PurchaseDetail>(new Action<PurchaseDetail>(this.attach_PurchaseDetails_LoginID), new Action<PurchaseDetail>(this.detach_PurchaseDetails_LoginID));
            this._PurchaseDetails_LoginID1 = new EntitySet<PurchaseDetail>(new Action<PurchaseDetail>(this.attach_PurchaseDetails_LoginID1), new Action<PurchaseDetail>(this.detach_PurchaseDetails_LoginID1));
        ...
        /// <summary>
        /// There are no comments for PurchaseDetails_LoginID in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_PurchaseDetail", Storage="_PurchaseDetails_LoginID", ThisKey="LoginID", OtherKey="LoginID", DeleteRule="NO ACTION")]
        public EntitySet<PurchaseDetail> PurchaseDetails_LoginID
        {
            get
            {
                return this._PurchaseDetails_LoginID;
            }
            set
            {
                this._PurchaseDetails_LoginID.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for PurchaseDetails_LoginID1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_PurchaseDetail1", Storage="_PurchaseDetails_LoginID1", ThisKey="LoginID", OtherKey="LoginID", DeleteRule="NO ACTION")]
        public EntitySet<PurchaseDetail> PurchaseDetails_LoginID1
        {
            get
            {
                return this._PurchaseDetails_LoginID1;
            }
            set
            {
                this._PurchaseDetails_LoginID1.Assign(value);
            }
        }
        ...
        private void attach_PurchaseDetails_LoginID(PurchaseDetail entity)
        {
            this.SendPropertyChanging("PurchaseDetails_LoginID");
            entity.LoginDetail_LoginID = this;
        }
    
        private void detach_PurchaseDetails_LoginID(PurchaseDetail entity)
        {
            this.SendPropertyChanging("PurchaseDetails_LoginID");
            entity.LoginDetail_LoginID = null;
        }

        private void attach_PurchaseDetails_LoginID1(PurchaseDetail entity)
        {
            this.SendPropertyChanging("PurchaseDetails_LoginID1");
            entity.LoginDetail_LoginID1 = this;
        }
    
        private void detach_PurchaseDetails_LoginID1(PurchaseDetail entity)
        {
            this.SendPropertyChanging("PurchaseDetails_LoginID1");
    ...
    public partial class PurchaseDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_PurchaseDetail", Storage="_LoginDetail_LoginID", ThisKey="LoginID", OtherKey="LoginID", IsForeignKey=true)]
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._LoginDetail_LoginID.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (previousValue != null)
                    {
                        ...
                        previousValue.PurchaseDetails_LoginID.Remove(this);
                    }
                    this._LoginDetail_LoginID.Entity = value;
                    if (value != null)
                    {
                        this._LoginID = value.LoginID;
                        value.PurchaseDetails_LoginID.Add(this);
                    }
                    else
                    {
                        this._LoginID = default(int?);
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_PurchaseDetail1", Storage="_LoginDetail_LoginID1", ThisKey="LoginID", OtherKey="LoginID", IsForeignKey=true)]
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._LoginDetail_LoginID1.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (previousValue != null)
                    {
                        ...
                        previousValue.PurchaseDetails_LoginID1.Remove(this);
                    }
                    this._LoginDetail_LoginID1.Entity = value;
                    if (value != null)
                    {
                        this._LoginID = value.LoginID;
                        value.PurchaseDetails_LoginID1.Add(this);
                    }
                    else
                    {
                        this._LoginID = default(int?);
